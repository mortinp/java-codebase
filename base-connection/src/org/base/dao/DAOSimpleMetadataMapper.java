    ...
    public DAOSimpleMetadataMapper(String metadataFilePath, String dataSourceContextName) {
        ...
        setDataMappingStrategy(new DefaultDataMappingStrategy() {
            ...
            public Object createResultObject(ResultSet rs) throws SQLException {
                return mappingBuilder.buildObject(DAOUtils.rowToMap(rs));
            }
        });
    }
    ...
    public void insert(Object objModelo, Connection conn) throws ExceptionDBDuplicateEntry {
        ...
        if(autonumericEntries.isEmpty()) {
            ...
            try {
                ...
                if (rs != null && rs.next()) {
                    /*
                     * TODO: Instead of using autonumericEntries, use an array with the actual fields names
                     * retrieved in the resultset.
                     * The fact is that some databases return the fields in different ways
                     */
                    SimpleMappingBuilder.fillObjectFromEntries(objModelo, autonumericEntries, DAOUtils.rowToMap(rs));
                }
            } catch (SQLException ex) {
                if (ex.getSQLState() == null) {
                    ex = (SQLException) ex.getCause();
                }
                if (ex != null && ex.getSQLState().equals(AbstractConnectionPool.UNIQUE_VIOLATION)) {
