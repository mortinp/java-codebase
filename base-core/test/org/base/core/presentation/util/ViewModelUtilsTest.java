...
import org.base.core.tests.pico.*;
 ...
 * @author martin
 */
public class ViewModelUtilsTest extends TestCase {
    ...
    public void testLazySetterInjection() {
        try {
           ...
           /* MutablePicoContainer pico = new TransientPicoContainer(new Reinjection(new MethodInjection("setLazyAttr"), null), null);  
            ...
            Logger.getLogger(ViewModelUtilsTest.class.getName()).log(Level.SEVERE, null, ex);
