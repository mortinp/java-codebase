 ...
 * @author mproenza
 */
public abstract class DAOAutonumericModel extends DAOAutonumeric {
    
    public DAOAutonumericModel(String dataSourceContextName, IDataMappingStrategy mappingStrategy) {
